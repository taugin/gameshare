package com.chukong.sdkmini.serv;
...
import com.chukong.sdkmini.serv.req.HttpFBHandler;
import com.chukong.sdkmini.serv.req.HttpProgressHandler;
...
public class WebServer extends Thread {
    ...
    public void run() {
        try {
            ...
            Log.d(Log.TAG, "WebServer is started on address : " + getAddressAndPort());
            /* 循环接收各客户端 */ 
            isLoop = true;
