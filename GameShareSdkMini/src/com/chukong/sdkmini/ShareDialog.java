...
import com.chukong.sdkmini.serv.WebServer.OnWebServListener;
import com.chukong.sdkmini.service.WebService;
...
public class ShareDialog extends Dialog implements OnWifiApStateChangeListener, OnWebServListener, OnDismissListener {
    ...
    protected void doBindService() {
        ...
        boolean ret = getContext().bindService(webServIntent, servConnection, Context.BIND_AUTO_CREATE);
