...
public class UDPSocketMonitor extends Thread {
    ...
    public void run() {
        ...
        System.out.println("Starting UDP socket monitor on address "
        ...
        while (true) {
            try {
                ...
                System.out.println("SocketException thrown from UDP socket on address "
                        + this.getAddressAndPort() + ", " + e);
                break;
            } catch (IOException e) {

                System.out.println("IOException thrown by UDP socket on address "
                        + this.getAddressAndPort() + ", " + e);
            }
        }
        System.out.println("UDP socket monitor on address " + getAddressAndPort()
                + " shutdown");
    }
